...
// Crop Disease Management Component
const CropDiseaseManagement = () => {
  return (
    <div className="container">
      <h1>Crop Disease Management</h1>
      <p>This page will provide tools and insights for managing crop diseases.</p>
    </div>
  );
};
  ...
  return (
    <Router>
      <div>
        ...
        <header className="header">
          ...
          <div className="header-wrapper">
            ...
            <div className="header-content">
              {/* Logo */}
              <img
                src="public\logo.png" // Replace with the path to your logo
                alt="Logo"
                className="logo"
              />
              {/* Navigation Links */}
        ...
        {/* Add Padding to Content to Avoid Overlap with Header */}
